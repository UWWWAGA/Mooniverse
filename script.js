...
let items = [
  ...
  },
  {
    ...
    rating: 4,
    duration: "",
    image: "https://store-images.s-microsoft.com/image/apps.26907.66622812769222919.f72813e2-a2c0-4178-94a9-276818a15412.4550e363-a2ec-40d5-8675-6f51579057ff",
    ...
    rating: 4,
    duration: "52ч 12м",
    image: "https://avatars.mds.yandex.net/i?id=c2b52a7c5621afddbbd6534e7d7cb8ee_l-10415036-images-thumbs&n=13",
    review: "Это была самая долгая игра с аукциона, когда либо побеждавшая, это ещё была и офигенная игра!  Отличная история, позволяющая мне, как новичку окунуться во вселенную  вахи,  грим дарк это очень круто, поэтому я её тепло приветствовал. Много слов писать не буду, читать всё это долгие часы было утомительно и интересно, мы сделали это и я очень и очень доволен! Лучшей главой в игре считаю 3-ю, прошёл её за один присест и получил невероятный кайф, а в 5-й когда всё встало на свои места, ты уже ощущаешь вообще всю полноту картины , сил писать уже что-либо нет, ибо игра высосала вообще все соки, сейчас ощущаю лишь приятное послевкусие. 8/10 - 2 балла снял из-за отсутствия озвучки многих диалогов, ну и душных космических боёв, сюда ещё можно приплести сложную прокачку персонажей, но игра вроде в корне как раз создана для таких вот ребят, кто любит в этом всём покопаться и создать свой идеальный билд",
    watchUrl: "https://www.youtube.com/watch?v=1tJA04R2KG0",
    service: "YouTube",
  },
  {
